...
static const _SetPwm_Request_type_support_symbol_names_t _SetPwm_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, balance_hw_interfaces, srv, SetPwm_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, balance_hw_interfaces, srv, SetPwm_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, balance_hw_interfaces, srv, SetPwm_Request)() {
  return &::balance_hw_interfaces::srv::rosidl_typesupport_c::SetPwm_Request_message_type_support_handle;
}
...
static const _SetPwm_Response_type_support_symbol_names_t _SetPwm_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, balance_hw_interfaces, srv, SetPwm_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, balance_hw_interfaces, srv, SetPwm_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, balance_hw_interfaces, srv, SetPwm_Response)() {
  return &::balance_hw_interfaces::srv::rosidl_typesupport_c::SetPwm_Response_message_type_support_handle;
}
...
static const _SetPwm_Event_type_support_symbol_names_t _SetPwm_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, balance_hw_interfaces, srv, SetPwm_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, balance_hw_interfaces, srv, SetPwm_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, balance_hw_interfaces, srv, SetPwm_Event)() {
  return &::balance_hw_interfaces::srv::rosidl_typesupport_c::SetPwm_Event_message_type_support_handle;
}
...
static const _SetPwm_type_support_symbol_names_t _SetPwm_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, balance_hw_interfaces, srv, SetPwm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, balance_hw_interfaces, srv, SetPwm)),
  }
};
...
static const rosidl_service_type_support_t SetPwm_service_type_support_handle = {
  ...
  &SetPwm_Request_message_type_support_handle,
  &SetPwm_Response_message_type_support_handle,
  &SetPwm_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, balance_hw_interfaces, srv, SetPwm)() {
  return &::balance_hw_interfaces::srv::rosidl_typesupport_c::SetPwm_service_type_support_handle;
}
